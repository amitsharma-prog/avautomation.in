...
Text Domain: scroll-rss-excerpt
...
<?php
	...
	if (isset($_POST['srsse_submit'])) 
	{
		...
		$srsse_height_1 	= stripslashes(sanitize_text_field($_POST['srsse_height_1']));
		$srsse_display_1 	= stripslashes(sanitize_text_field($_POST['srsse_display_1']));
		$srsse_length_1 	= stripslashes(sanitize_text_field($_POST['srsse_length_1']));
		
		$srsse_height_2 	= stripslashes(sanitize_text_field($_POST['srsse_height_2']));
		$srsse_display_2 	= stripslashes(sanitize_text_field($_POST['srsse_display_2']));
		$srsse_length_2 	= stripslashes(sanitize_text_field($_POST['srsse_length_2']));
		
		$srsse_height_3 	= stripslashes(sanitize_text_field($_POST['srsse_height_3']));
		$srsse_display_3 	= stripslashes(sanitize_text_field($_POST['srsse_display_3']));
		$srsse_length_3 	= stripslashes(sanitize_text_field($_POST['srsse_length_3']));
		
		$srsse_height_4 	= stripslashes(sanitize_text_field($_POST['srsse_height_4']));
		$srsse_display_4 	= stripslashes(sanitize_text_field($_POST['srsse_display_4']));
		$srsse_length_4 	= stripslashes(sanitize_text_field($_POST['srsse_length_4']));
		
		if(!is_numeric($srsse_height_1)) { $srsse_height_1 = 200; }
		if(!is_numeric($srsse_display_1)) { $srsse_display_1 = 2; }
		if(!is_numeric($srsse_length_1)) { $srsse_length_1 = 20; }

		if(!is_numeric($srsse_height_2)) { $srsse_height_2 = 200; }
		if(!is_numeric($srsse_display_2)) { $srsse_display_2 = 2; }
		if(!is_numeric($srsse_length_2)) { $srsse_length_2 = 20; }
		
		if(!is_numeric($srsse_height_3)) { $srsse_height_3 = 200; }
		if(!is_numeric($srsse_display_3)) { $srsse_display_3 = 2; }
		if(!is_numeric($srsse_length_3)) { $srsse_length_3 = 20; }
		
		if(!is_numeric($srsse_height_4)) { $srsse_height_4 = 200; }
		if(!is_numeric($srsse_display_4)) { $srsse_display_4 = 2; }
		if(!is_numeric($srsse_length_4)) { $srsse_length_4 = 20; }
		...
		$srsse_s1 = stripslashes(sanitize_text_field($_POST['srsse_s1']));
		$srsse_s2 = stripslashes(sanitize_text_field($_POST['srsse_s2']));
		$srsse_s3 = stripslashes(sanitize_text_field($_POST['srsse_s3']));
		$srsse_s4 = stripslashes(sanitize_text_field($_POST['srsse_s4']));
		
		$srsse_s1 = esc_url_raw( $srsse_s1 );
		$srsse_s2 = esc_url_raw( $srsse_s2 );
		$srsse_s3 = esc_url_raw( $srsse_s3 );
		$srsse_s4 = esc_url_raw( $srsse_s4 );
	...
	if ( ! is_wp_error( $rss ) )
	{
		...
		if ( $maxitems > 0 )
		{
			foreach ( $rss_items as $item )
			{
				...
				$srsse_text = sanitize_text_field($srsse_text);
				$srsse_target = "_blank";
